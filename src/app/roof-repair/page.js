...
<div
    ...
    >
      <div className="relative z-10">
        {/* Heading */}
        <h2 className="text-4xl font-bold text-white mb-4">Plumbing Services</h2>
        {/* Description */}
        <div className="text-lg text-white mb-6">
          Experience worry-free plumbing with our seamless solutions. Don’t wait – reach out now for prompt and dependable service, ensuring your pipes stay clear and your home stays in top shape! Contact us today and let’s get your plumbing sorted!
        </div>
