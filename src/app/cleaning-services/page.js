...
<div
    ...
    >
      <div className="relative z-10">
        {/* Heading */}
        <h2 className="text-4xl font-bold text-white mb-4">Roof Repair</h2>
        {/* Description */}
        <div className="text-lg text-white mb-6">
      
        Protect your home from above! Experience top-quality roof repairs that safeguard your family and belongings – let’s keep you covered. Contact us today for a sturdy, worry-free roof!</div>
